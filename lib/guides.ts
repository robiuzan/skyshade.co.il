...
export const guides: Guide[] = [
  ...
  {
    slug: "pergola-sukkah",
    title: "פרגולה מותאמת לסוכה — מה חשוב לבדוק לפני שמתכננים",
    seoTitle: "פרגולה מותאמת לסוכה — מה לבדוק",
    description:
      "איך מתכננים פרגולת אלומיניום שמאפשרת להקים תחתיה סוכה: פתיחה מלאה לשמיים, מעמיד הסכך, גובה ומידות, ומה לבקש כבר בשלב המדידה. שאלות ההלכה — לרב שלכם.",
    summary:
      "פתיחה מלאה מול להבים, שאלת המעמיד, ומה לבקש בשלב המדידה כדי שלא יהיה מאוחר.",
